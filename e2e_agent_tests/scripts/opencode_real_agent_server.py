...
def build_app(workdir: Path, upstream_base_url: str, upstream_api_key: str, model_timeout: float):
...
def main() -> None:
    ...
    app = build_app(Path(args.workdir), args.upstream_base_url, key, args.timeout)
